    ...
    <nav  class="container-fluid navbar navbar-expand-md navbar-dark bg-dark fixed-top" style="width:100%"> 
        ...
        <div   class="collapse navbar-collapse justify-content-end" id="navbarCollapse">
          <ul  class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link h6 font-weight-light font-monospace" href="/cart" >CART</a>
            </li>
            <li class="nav-item">
              <a class="nav-link h6 font-weight-light font-monospace" href="/home" >PRODUCTS</a>
            </li>
            <li class="nav-item">
              <a class="nav-link h6 font-weight-light font-monospace" href="/userprofile" >PROFILE</a>
            </li>
            <li class="nav-item">
